        ...
        <div id="id-card-container" class="relative mx-auto" style="width:302px; height:480px;">
            ...
            <div id="card-front" class="absolute inset-0 transition-opacity duration-300" style="width:302px; height:478px;">
                <div style="width:302px; height:478px; border:1px solid #c7d2e0; border-radius:14px; overflow:hidden; background:#fff; font-family:'Segoe UI',Arial,sans-serif; box-shadow:0 4px 20px rgba(0,0,0,0.08); display:flex; flex-direction:column;">
                    <!-- Blue Header -->
                    <div style="background:linear-gradient(135deg,#1e3a8a 0%,#2563eb 100%); padding:55px 20px 40px; text-align:center;">
                        <img src="<?php echo escape($site_logo); ?>" alt="Logo" style="display:block; margin:0 auto 6px; height:24px; object-fit:contain; filter:brightness(0) invert(1);">
                    ...
                    <div style="padding:0 22px 10px; text-align:center; flex:1; display:flex; flex-direction:column;">
                        ...
                        <div style="font-size:16px; font-weight:900; color:#111827; text-transform:uppercase; letter-spacing:0.5px; line-height:1.2; margin-bottom:4px;">
                            <?php echo escape($user['full_name']); ?>
                        </div>
                        <div style="font-size:11px; font-weight:800; color:#4b5563; text-transform:uppercase; letter-spacing:2px; margin-bottom:auto;">
            ...
            <div id="card-back" class="absolute inset-0 transition-opacity duration-300 opacity-0 pointer-events-none" style="width:302px; height:478px;">
                <div style="width:302px; height:478px; border:1px solid #c7d2e0; border-radius:14px; overflow:hidden; background:#fff; font-family:'Segoe UI',Arial,sans-serif; box-shadow:0 4px 20px rgba(0,0,0,0.08); display:flex; flex-direction:column;">
                    <div style="background:linear-gradient(135deg,#1e3a8a 0%,#2563eb 100%); padding:55px 20px 20px; text-align:center;">
                        <img src="<?php echo escape($site_logo); ?>" alt="Logo" style="display:block; margin:0 auto 4px; height:24px; object-fit:contain; filter:brightness(0) invert(1);">
