...
<div class="space-y-6">
    ...
    <form id="post-form" method="POST" enctype="multipart/form-data" class="space-y-6">
        ...
        <input type="hidden" name="autosave_post_id" id="autosave_post_id" value="">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="col-span-1 md:col-span-2 border-t pt-6 mt-4">
                    ...
                    <div id="faq-container" class="space-y-4">
                        ...
                        if (!empty($_POST['faq_q']) && !empty($_POST['faq_a'])) {
                            for ($i=0; $i<count($_POST['faq_q']); $i++) {
                                if(!empty(trim($_POST['faq_q'][$i]))) {
                                    $faqs[] = ['q' => trim($_POST['faq_q'][$i]), 'a' => trim($_POST['faq_a'][$i])];
                                }
                            }
                        }
...
$(document).ready(function() {
    ...
    function autoSave() {
        ...
        // Do not auto-save if there is no title
        if (!title) return;

        // Ensure TinyMCE is synced to the textarea
        ...
        // Convert FormData to URLSearchParams to easily serialize it for comparison
